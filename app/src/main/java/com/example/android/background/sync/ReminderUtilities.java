...
public class ReminderUtilities {
    // Create three constants and one variable:
    /*
    ...
    synchronized public static void scheduleChargingReminder(@NonNull final Context context) {
        ...
        // Use FirebaseJobDispatcher's newJobBuilder method to build a job
        Job constraintReminderJob = dispatcher.newJobBuilder()

                // - has WaterReminderFirebaseJobService as it's service. This is the Service that
                // will be used to write to preferences
                .setService(WaterReminderFirebaseJobService.class)

                // - has the tag REMINDER_JOB_TAG. Set the UNIQUE tag used to identify this Job.
                 ...
                 * charging. In a normal app, it might be a good idea to include a preference for
                 * this, as different users may have different preferences on when you should be
                ...
                // - has the job recur. We want these reminders to continuously happen, so we tell
                // this Job to recur.
                .setRecurring(true)
                 ...
                 * Trigger class's static exectuionWindow method is the start of the time frame when
                 * the job should be performed. The second argument is the latest point in time at
                 * which the data should be synced. Please note that this end time is not guaranteed
                 * but is more of a guideline for FirebaseJobDispatcher to go off of.
                 */
                ...
                /*
                 * If a Job with the tag provided already exists, this new job will replace the old
                 * one.
                 */
